    ...
    >
      <div className="relative z-10 flex flex-col items-center text-center gap-6 max-w-[960px] w-full mx-auto">
        ...
        >
          <a
            href="#ingressos"
            className="w-full sm:w-auto text-[15px] font-bold tracking-[0.02em] px-9 py-4 transition-all duration-200 rounded-md text-center shadow-lg hover:shadow-xl cursor-pointer inline-block"
            style={{
